...
function compute()
{
    var p = parseFloat(document.getElementById("principal").value,10);
   var r = parseFloat(document.getElementById("ratespan").value,10);
    var n= parseFloat(document.getElementById("Years").value,10);
